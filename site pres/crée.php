...
<head>
  ...
  <link rel="stylesheet" href="css\crée.css">
...
<body>
    ...
    <div>
      ...
      <form action="traitement.php" method="POST">
        <table>
          ...
          <tr>
            ...
            <td>            
              <div class="formulaire">
                <ion-icon name="person"></ion-icon>
                <input type="text" name="tel" placeholder="N° Telephone"><br>
              </div>
            </td>
          </tr>
        ...
        <table style="padding-right: 460px">
          <tr>
            <td>            
              <div class="formulaire" style="width:100%">
                <ion-icon name="person"></ion-icon>
                <input type="text" name="mail" placeholder="Adresse m@il"><br>
              </div>
            </td>
          </tr>
        </table>
        ...
        <table>
           <tr>
            ...
            <td>            
              <div class="formulaire">
                <ion-icon name="lock"></ion-icon>
                <input type="password" name="mdp1" placeholder="Vérification du mot de passe"><br><br><br>
              </div>
            </td>
          </tr>
          <tr> 
            <td style="padding-left: 160px">
              <div>
                <input class="envoyer" type="submit" name="env" value="Créer">
              </div>
              <br>
            </td>
            <td>
              <div>
                <input class="envoyer" type="reset" name="env" value="Annuler">
              </div>
              <br>
            </td>
